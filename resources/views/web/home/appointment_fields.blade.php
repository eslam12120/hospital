...
<div class="row">
    ...
    <div class="col-lg-6 paymentType d-none">
        <div class="appointment-form__input-block">
            <label for="payment_mode" class="form-label">{{ __('messages.ipd_payments.payment_mode') }} :<span class="required paymentMode d-none">*</span></label>
    ...
    @if (count($customField) >= 0)
            ...
            <div class="appointment-form__input-block col-sm-{{$field['grid']}} mb-5 text-capitalize">
                ...
                <div class="form-check form-switch">
                    <input style="height: 25px;width:40px" class="form-check-input front-appointment-switch is-active {{ $field['is_required'] == 1 ? 'dynamic-field' : ''}}" name={{$fieldName}} type="checkbox" value="1"
